...
class CRUDBooster
{
    ...
    public static function sendEmail($config = [])
    {
        ...
        $button = "<div class='text-center'><a href='".$config['link_reset_password']."' class='btn btn-primary'><button style='background-color: #3379A1; color: #FFFFFF; width: 100px; height: 50px;'>Reset Password</button></a></div>";
        $html = str_replace('[url_reset_password]', $button, $html);
