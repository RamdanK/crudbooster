...
Route::group(['middleware' => ['web'], 'prefix' => config('crudbooster.ADMIN_PATH'), 'namespace' => $namespace], function () {
    ...
    Route::get('register/group', ['uses' => 'AdminController@getRegisterGroup', 'as' => 'getRegisterGroup']);
    Route::post('register/group', ['uses' => 'AdminController@postRegisterGroup', 'as' => 'postRegisterGroup']);
    Route::get('register/personal', ['uses' => 'AdminController@getRegisterPersonal', 'as' => 'getRegisterPersonal']);
    Route::post('register/personal', ['uses' => 'AdminController@postRegisterPersonal', 'as' => 'postRegisterPersonal']);
    Route::get('reset-password',['uses' => 'AdminController@getResetPassword', 'as' => 'getResetPassword']);
