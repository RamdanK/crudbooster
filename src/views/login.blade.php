        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class='row'>
                <div class='col-xs-12' align="center">
                    <p style="padding:10px 0px 0px 0px">{{trans("crudbooster.text_forgot_password")}}
                         <a href='{{route("getForgot")}}'>{{trans("crudbooster.click_here")}}</a>
                    </p>
                    <p style="padding:0px 0px 10px 0px">{{trans("crudbooster.text_register")}}
                            <a href='{{route("getRegister")}}'>{{trans("crudbooster.click_here")}}</a>
                    </p>
                </div>
            </div>
        </form>
