...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form autocomplete='off' action="{{ route('postRegisterGroup') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='name' value="{{ old('name') }}" required placeholder="Group Name"/>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>            
            
            <div class="form-group">
                <textarea name="description" id="description" rows="3" class="form-control" placeholder="Description">{{ old('description') }}</textarea>
            </div>            
            ...
            <div style="margin-bottom:10px" class='row'>
                <div class='col-xs-12'>
                    ...
                    <a href="{{route("getRegister")}}" class="btn btn-warning btn-block"><i class="fa fa-arrow-left"></i> Cancel</a>
                </div>
            </div>
        </form>
        <br/>
