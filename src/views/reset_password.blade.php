...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <p class="login-box-msg">Enter your new password and confirmation password.</p>
        <form action="{{ route('postResetPassword') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            <input type="hidden" name="token_reset_password" value="{{ g('token') }}">
            <div class="form-group has-feedback">
                <input autocomplete='off' type="password" class="form-control" name='password' value="{{ old('password') }}" required placeholder="New Password"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input autocomplete='off' type="password" class="form-control" name='password_confirmation' value="{{ old('password_confirmation') }}" required placeholder="Confirm Your New Password"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-8">
